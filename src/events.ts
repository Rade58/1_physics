...
// we can listen to:    collide      sleep     wakeup

// we can play sound for example when bodies collide

// we will load sound with Audio constructor (a javascript native thing)
// we will define function that will play mentioned sound
// and mentioned function will be on collide listener
